...
// Set Theme
	...
	GetPrivateProfileString(_T("Settings"), _T("Theme"), _T("ShizukuTeaBreak"), str, 256, m_Ini);
	m_CurrentTheme = str;
#else
	if(IsClassicSystem())
	{
		GetPrivateProfileString(_T("Settings"), _T("Theme"), _T("classic"), str, 256, m_Ini);
		m_CurrentTheme = str;
	}
...
#ifdef SUISHO_SHIZUKU_SUPPORT
					if(_tcsstr(findData.cFileName, _T("ShizukuTeaBreak")) != NULL)
#else
...
#ifdef SUISHO_SHIZUKU_SUPPORT
		m_CurrentTheme = _T("ShizukuTeaBreak");
#else
