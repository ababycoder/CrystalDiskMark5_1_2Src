...
#define PRODUCT_VERSION			_T("5.1.2")
#define PRODUCT_ROMING_NAME		_T("CrystalDiskMark5")
...
#define PRODUCT_RELEASE			_T("2016/02/03")
#define PRODUCT_COPY_YEAR		_T("2007-2016")
#define PRODUCT_COPYRIGHT		_T("&copy; hiyohiyo 2007-2016 ")
...
#define	URL_CDM_LICENSE_JA			_T("http://crystalmark.info/software/CrystalDiskMark/manual-ja/License.html")
#define	URL_CDM_LICENSE_EN			_T("http://crystalmark.info/software/CrystalDiskMark/manual-en/License.html")

#define URL_DISKSPD					_T("https://github.com/microsoft/diskspd")

#define URL_HTML_HELP_JA			_T("http://crystalmark.info/software/CrystalDiskMark/manual-ja/")
#define URL_HTML_HELP_EN 			_T("http://crystalmark.info/software/CrystalDiskMark/manual-en/")
